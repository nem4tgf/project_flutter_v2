...
class PaymentService {
  final String _baseUrl = kIsWeb ? 'http://localhost:8080/api/payments' : 'http://192.168.2.8:8080/api/payments';
  final String _orderDetailsUrl = kIsWeb ? 'http://localhost:8080/api/order-details' : 'http://192.168.2.8:8080/api/order-details';
