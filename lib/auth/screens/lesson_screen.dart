...
import '../../models/enrollment.dart'; // Thêm import này
import '../../models/learning_material.dart';
import '../../models/quiz.dart';
import '../../models/flashcard.dart';
import '../../models/progress.dart';
import '../../services/auth_service.dart';
import '../../services/lesson_service.dart'; // Thêm import này
import '../../services/enrollment_service.dart'; // Thêm import này
import '../../services/learning_material_service.dart';
import '../../services/quiz_service.dart';
import '../../services/flashcard_service.dart';
import '../../services/progress_service.dart';
import 'cart_screen.dart'; // Thêm import này
...
class _LessonScreenState extends State<LessonScreen> with TickerProviderStateMixin {
  ...
  void _addToCart(int lessonId, String title, Decimal price) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Đã thêm bài học "$title" vào giỏ hàng', style: const TextStyle(color: Colors.white)),
  ...
  bool _isLessonAccessible(Lesson lesson, List<Enrollment> enrollments) {
    ...
    final activeEnrollment = enrollments.firstWhereOrNull(
          (e) => e.lesson.lessonId == lesson.lessonId && e.status == 'ACTIVE' && e.expiryDate.isAfter(DateTime.now()),
    );
    return activeEnrollment != null; // Lesson is accessible if an active enrollment exists
  }
        ...
        return FutureBuilder<List<Enrollment>>(
          ...
          builder: (context, enrollmentSnapshot) {
            ...
            if (filteredLessons.isEmpty) {
              return Center(
                child: Text(
                  showAccessibleLessons ? 'Bạn chưa có khóa học nào đang học.' : 'Không có khóa học nào để mua thêm.',
                  textAlign: TextAlign.center,
            ...
            return GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                // Lấy enrollment hiện tại nếu có để hiển thị ngày hết hạn
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: TextStyle(fontSize: isSmallScreen ? 10 : 12, color: Colors.black54),
                              maxLines: 1,
                              overflow: TextOverflow.ellipsis,
                            ),
                            ...
                            if (isAccessible && currentEnrollment != null) // Đảm bảo currentEnrollment không null
                              Text(
                                'Hết hạn: ${currentEnrollment.expiryDate.toLocal().toString().split(' ')[0]}',
                                style: TextStyle(fontSize: isSmallScreen ? 10 : 12, color: Colors.redAccent),
                              ),
                            const Spacer(),
                            Row(
                              ...
                              children: [
                                ...
                                Icon(
                                  isAccessible ? AntDesign.playcircleo : AntDesign.shoppingcart,
                                  color: isAccessible ? Colors.green : const Color(0xFF4A90E2),
